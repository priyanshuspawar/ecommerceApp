...
const ProductCard = (props: props) => {
  ...
  return (
    <div className="flex relative flex-col w-max max-w-lg">
      <div
        className="flex overflow-hidden h-80 group 
     bg-[#F5F6F6] rounded-lg w-max"
      >
        {/* product image */}
        <div className="flex flex-grow  m-6 justify-center hover:scale-125 transition transform-gpu duration-100 delay-75 ease-in items-center">
          <img
